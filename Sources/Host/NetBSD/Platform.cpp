...
char const *Platform::GetOSTypeName() { return "netbsd"; }
...
std::string Platform::GetThreadName(ProcessId pid, ThreadId tid) {
  return Host::NetBSD::ProcStat::GetThreadName(pid, tid);
}
} // namespace Host
} // namespace ds2
