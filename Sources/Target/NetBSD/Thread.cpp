...
#include "DebugServer2/Host/NetBSD/ProcStat.h"
...
void Thread::updateState(bool force) {
  ...
  switch (state) {
  case Host::NetBSD::kProcStateDead:
  case Host::NetBSD::kProcStateZombie:
    _state = kTerminated;
    break;

  case Host::NetBSD::kProcStateSleeping:
  case Host::NetBSD::kProcStateRunning:
  case Host::NetBSD::kProcStateWaiting:
  case Host::NetBSD::kProcStateLock:
    _state = kRunning;
    break;

  case Host::NetBSD::kProcStateStopped:
    _state = kStopped;
    break;
